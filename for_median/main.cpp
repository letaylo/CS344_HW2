...
void msort(int array[], int start, int size, int& cost); // mergesort
...
void my_qsort(int array[], int start, int size, int& cost, int (*choose_pivot)(int [], int, int, int )); // quicksorti
